...
import type { NodeTypeToken } from './graph.mjs';
import type { Label } from './shared.mjs';
/**
 ...
 */
export declare function defineNode<T extends NodeTypeToken = NodeTypeToken, Node extends GraphNode<T> = GraphNode<T>>(data: Node): Node;
/**
 * Define a node with type inference and some default values.
 * @param data - The data of the node.
 */
export declare function defineNodeWithDefaults<T extends NodeTypeToken = NodeTypeToken>(data: Partial<GraphNode<T>> & Pick<GraphNode, 'id' | 'type'>): GraphNode<T>;
